...
import { useDepartmentsQuery } from '@/hooks/use-organization';
...
export default function DepartmentMembersPage() {
  ...
  const { data: Teams = [], isLoading } = useDepartmentsQuery(teams?.toString());

  const handleMemberClick = (memberId: string) => {
    router.push(`/hierarchy/directors/${id}/teams/${teams}/employees/${memberId}`);
  };
