...
const translations = {
  en: {
    ...
    'amharic.keyboard.placeholder': 'Enter your text here',
    ...
    'employees.noMembers': 'There is no data',
    'employees.noEmployees': 'There are no employees',
    'error.showKeyboard': 'Please use your device’s built-in keyboard.',
  ...
  am: {
    ...
    'complaints.track.input': 'ኮድዎን እዚህ ያስገቡ',
    'complaints.track.submit': 'አስገባ',
    ...
    'employees.noMembers': 'ምንም መረጃ የለም',
    'employees.noEmployees': 'ምንም ሰራተኞች የሉም',
    ratings: 'ደረጃዎች',
    about: 'ስለ እኛ',
    contact: 'ያግኙን',
    'error.showKeyboard': 'የአማርኛ ኪቦርድ ማሳየት አይቻልም።',
    ...
    'amharic.keyboard.placeholder': 'ጽሑፍዎን እዚህ ያስገቡ',
  ...
  af: {
    ...
    'error.showKeyboard': 'kiiboordii Afaan Amaaraa hin mul’atu.',
    ...
    'employees.members': 'Miseensota',
    'employees.noMembers': 'Odeeffannoon hin jiru',
    'employees.noEmployees': 'Hojjettoonni hin jiran',
